...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.51/Connect_XCFramework_Debug.zip",
            checksum: "415d45138a843a7d3735fc06a12243c2b1e229c8611232415c4f98656e2f4fe5"),
        .binaryTarget(
            name: "Tealeaf",
