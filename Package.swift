...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.22/Connect_XCFramework_Debug.zip",
            checksum: "9f39f287e7d8745f3838df6534364ca2f4ac6c5fc08d806b89dc781b50d3df5c"),
        .binaryTarget(
            name: "Tealeaf",
