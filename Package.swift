...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.121/Connect_XCFramework_Debug.zip",
            checksum: "25f747759ca00bfa97a01ad4ee78948f45884f3fa20e635a666eed43f4b0a22e"),
        .binaryTarget(
            name: "Tealeaf",
