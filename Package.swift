...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.25/Connect_XCFramework_Debug.zip",
            checksum: "d44c8cba7ec7276a6c02317c2549baf897ed5d7e174fa1408db15bb24b932683"),
        .binaryTarget(
            name: "Tealeaf",
