...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.54/Connect_XCFramework_Debug.zip",
            checksum: "d6d890a55dab30648379179781e41332d8ef6309fb9fcbf81af11ba05565305a"),
        .binaryTarget(
            name: "Tealeaf",
