...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.66/Connect_XCFramework_Debug.zip",
            checksum: "a0996009c8af2842ac4ac909d65750d7d8e778910bcbb97f53c2e8a70b8e9847"),
        .binaryTarget(
            name: "Tealeaf",
