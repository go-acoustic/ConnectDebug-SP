...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.67/Connect_XCFramework_Debug.zip",
            checksum: "c86651d18a0f857055068ddb1fd94d75902e94bbd8f4d478422a29cdb7cba396"),
        .binaryTarget(
            name: "Tealeaf",
