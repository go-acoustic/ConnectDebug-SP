...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.112/Connect_XCFramework_Debug.zip",
            checksum: "de211dec10eb1434156286b84cb27260e514f3ab55f9c1f60888c7f85bde5059"),
        .binaryTarget(
            name: "Tealeaf",
