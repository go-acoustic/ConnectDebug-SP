...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.30/Connect_XCFramework_Debug.zip",
            checksum: "be9bcd366b6903d4f0e7dc51e0556d3dd371c440ff76b58068df7479b96ebc98"),
        .binaryTarget(
            name: "Tealeaf",
