...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.33/Connect_XCFramework_Debug.zip",
            checksum: "582eb85117a9d4ab9b562d4c943134621fe5291c17a5b70825720a9dafe06357"),
        .binaryTarget(
            name: "Tealeaf",
