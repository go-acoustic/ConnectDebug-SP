...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.109/Connect_XCFramework_Debug.zip",
            checksum: "11649b8b411b5e237ac2fa6f16caabbc82f5014f09912b7b909d9b5303b2ceb5"),
        .binaryTarget(
            name: "Tealeaf",
