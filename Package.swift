...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.21/Connect_XCFramework_Debug.zip",
            checksum: "85e376c35a1b7426f63be75249c25e10185ed6a0327dffd3be8a0b0b09ecd27c"),
        .binaryTarget(
            name: "Tealeaf",
