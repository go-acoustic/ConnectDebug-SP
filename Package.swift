...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.114/Connect_XCFramework_Debug.zip",
            checksum: "bc4addd0c9d0f8d6e5212c41020bf63c5f4939987cac6ab15d00cf457e5b587b"),
        .binaryTarget(
            name: "Tealeaf",
