...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.120/Connect_XCFramework_Debug.zip",
            checksum: "81a968491144555566e68cb7f0ffef8dacfaaba7957b01bcdf218776c45cab0f"),
        .binaryTarget(
            name: "Tealeaf",
