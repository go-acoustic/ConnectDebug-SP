...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.52/Connect_XCFramework_Debug.zip",
            checksum: "9b2b9aa70ddc617cc42a5655cf8b4b2103886932912f3d0333dcb51ee2757d39"),
        .binaryTarget(
            name: "Tealeaf",
