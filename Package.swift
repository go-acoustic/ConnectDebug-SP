...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.17/Connect_XCFramework_Debug.zip",
            checksum: "b212cf98b63386c10cc411fc2bd3551745fb20260dc4bc862b215117fcf64615"),
        .binaryTarget(
            name: "Tealeaf",
