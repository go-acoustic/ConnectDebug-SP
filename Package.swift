...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.47/Connect_XCFramework_Debug.zip",
            checksum: "83815df27d8faccd707138b0d0645952002dd6a67e5412b44b1fc40c3d9a7007"),
        .binaryTarget(
            name: "Tealeaf",
