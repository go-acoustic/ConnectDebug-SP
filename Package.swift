...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.104/Connect_XCFramework_Debug.zip",
            checksum: "6c6b9443335ecbc63d95bc570f6f94a89a8117f2176c753f900723a65bfb3f7b"),
        .binaryTarget(
            name: "Tealeaf",
