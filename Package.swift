...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.115/Connect_XCFramework_Debug.zip",
            checksum: "f56f55f30b74dbf0ba6d14f03263d274b25b9d772a736a3c7c86adf189524ba4"),
        .binaryTarget(
            name: "Tealeaf",
