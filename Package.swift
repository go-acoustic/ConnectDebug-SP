...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.24/Connect_XCFramework_Debug.zip",
            checksum: "ec0210e30deea396d50c3483c14d96c1c70960f8fcd6dc5f05c7f0c5c9e42c50"),
        .binaryTarget(
            name: "Tealeaf",
