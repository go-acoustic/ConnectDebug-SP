...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.106/Connect_XCFramework_Debug.zip",
            checksum: "638c7119d4c8678035b359c8cdd0a06b5eb8d0ff431615d59168052023aee83c"),
        .binaryTarget(
            name: "Tealeaf",
