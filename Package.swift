...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.122/Connect_XCFramework_Debug.zip",
            checksum: "61490f950bc94dc3d110b87e41ca56ef189714e8afef0e01c07849f488a8b3fc"),
        .binaryTarget(
            name: "Tealeaf",
