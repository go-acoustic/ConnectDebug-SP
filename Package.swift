...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.107/Connect_XCFramework_Debug.zip",
            checksum: "8a067954a9e8470cfb5b6ac11544d17b97cdb5b2d38fd334c9cc2f8c5cde573c"),
        .binaryTarget(
            name: "Tealeaf",
