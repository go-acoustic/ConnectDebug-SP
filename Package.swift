...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.105/Connect_XCFramework_Debug.zip",
            checksum: "0e36b6081dc79af37384e3fea818693e8f7076c7f51a43f8bcc1bb4dbae32341"),
        .binaryTarget(
            name: "Tealeaf",
