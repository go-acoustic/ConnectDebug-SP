...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.55/Connect_XCFramework_Debug.zip",
            checksum: "9ca9e382f4c079afd890df3eaad4ddf6bc43d20f404d76035cb17fd23480314a"),
        .binaryTarget(
            name: "Tealeaf",
