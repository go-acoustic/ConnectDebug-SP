...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.32/Connect_XCFramework_Debug.zip",
            checksum: "9d1fa16e5f3ac18d7d35671348f463373576e5cfa7c276817a3381c8e2811c23"),
        .binaryTarget(
            name: "Tealeaf",
