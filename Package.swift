...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.29/Connect_XCFramework_Debug.zip",
            checksum: "11ce5f9a52d45cbd9b944bd3525be796949c234186aaa02a339b42f19c58f473"),
        .binaryTarget(
            name: "Tealeaf",
