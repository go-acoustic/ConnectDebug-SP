...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.26/Connect_XCFramework_Debug.zip",
            checksum: "a7428d056907f367230fcd6dac3a55b47d05d2cb826a08ac66eabb653cf18665"),
        .binaryTarget(
            name: "Tealeaf",
