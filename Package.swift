...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.40/Connect_XCFramework_Debug.zip",
            checksum: "ce0e5d44150b77d468682199c518dfffc3891c2743aebe2e6b8eb015e312f439"),
        .binaryTarget(
            name: "Tealeaf",
