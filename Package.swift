...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.108/Connect_XCFramework_Debug.zip",
            checksum: "425dac19ff8b3b15e851fd6079af213d8510140134a01113b57d0c4026fd98e3"),
        .binaryTarget(
            name: "Tealeaf",
