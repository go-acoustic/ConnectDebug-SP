...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.99/Connect_XCFramework_Debug.zip",
            checksum: "f1bb1c102650f3ed50461cb64e18d08a175ec7b38de81e06e596bc1b505768dd"),
        .binaryTarget(
            name: "Tealeaf",
