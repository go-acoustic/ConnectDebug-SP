...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.100/Connect_XCFramework_Debug.zip",
            checksum: "686513ee18061d1ccc8296308e5f6f767870bbf00f6b2979acdd452f25d8daaf"),
        .binaryTarget(
            name: "Tealeaf",
