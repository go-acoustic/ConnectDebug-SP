...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.36/Connect_XCFramework_Debug.zip",
            checksum: "22dc40191a2a4b5ea4515a9158e66389e3640a491b95d96eb29b990b484806f1"),
        .binaryTarget(
            name: "Tealeaf",
