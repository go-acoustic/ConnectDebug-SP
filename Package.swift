...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.56/Connect_XCFramework_Debug.zip",
            checksum: "d375e3759c8af3b41d65a2dceb723244718ef0609dc3f2cbcadcd24df7c887a0"),
        .binaryTarget(
            name: "Tealeaf",
