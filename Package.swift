...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.113/Connect_XCFramework_Debug.zip",
            checksum: "08f0e26649d7b97e0a80c495c412ef51ab22652e0393b064737b16607761bc54"),
        .binaryTarget(
            name: "Tealeaf",
