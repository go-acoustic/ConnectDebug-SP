...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.74/Connect_XCFramework_Debug.zip",
            checksum: "4a74f74762dcee70ef68c2e34570d47c093b74938fe210601ab6ca84a8a88e51"),
        .binaryTarget(
            name: "Tealeaf",
