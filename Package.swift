...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.27/Connect_XCFramework_Debug.zip",
            checksum: "792ee7975f2431bd6a1de2c5b1c238cc43a1a2c2e1bf4b828829b812cf7a7810"),
        .binaryTarget(
            name: "Tealeaf",
