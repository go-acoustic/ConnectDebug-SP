...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.19/Connect_XCFramework_Debug.zip",
            checksum: "61eabe47cd5148220c2e683a379403a92e63a5313092628d9bd6b22d7d9e7fe3"),
        .binaryTarget(
            name: "Tealeaf",
