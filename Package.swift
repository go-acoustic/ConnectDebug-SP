...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.111/Connect_XCFramework_Debug.zip",
            checksum: "0f9a7de71cca4475336a6fcc95bb9219736096c43834145e8c4ab321d831f8a5"),
        .binaryTarget(
            name: "Tealeaf",
