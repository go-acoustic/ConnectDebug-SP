...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.28/Connect_XCFramework_Debug.zip",
            checksum: "43f9b0c760cb38394a243cfc09747e45bad8950de0adf5d6c96c075ad1e3c688"),
        .binaryTarget(
            name: "Tealeaf",
