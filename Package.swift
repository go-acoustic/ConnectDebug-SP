...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.98/Connect_XCFramework_Debug.zip",
            checksum: "8b0aaa6fcb99da75ca5fc7342b654523c71875c7edbd3e12b4a59f7439672633"),
        .binaryTarget(
            name: "Tealeaf",
