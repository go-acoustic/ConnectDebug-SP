...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/2.0.6/Connect_XCFramework_Debug.zip",
            checksum: "04ab1ba2a6e1ac1fa0978cc8541cd22d4df6e6f8c32a3b2fc63a5efbd9c2cb24"),
        .binaryTarget(
            name: "Tealeaf",
