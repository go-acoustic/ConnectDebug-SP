...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.103/Connect_XCFramework_Debug.zip",
            checksum: "3d31afa55ca3a1b6b632a6bd7369481b49072d8d8a163993a11578cd4fa01fa2"),
        .binaryTarget(
            name: "Tealeaf",
