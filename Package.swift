...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.23/Connect_XCFramework_Debug.zip",
            checksum: "c631f0ea3ada800d3c7cfa561b1505e1135378c927c05a6ae9a7e2d5bf895971"),
        .binaryTarget(
            name: "Tealeaf",
