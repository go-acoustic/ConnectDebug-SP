...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.73/Connect_XCFramework_Debug.zip",
            checksum: "031843e04620edeb7864b416b3f8f772a1524bb4f521450a2bc44e03ea4bce8a"),
        .binaryTarget(
            name: "Tealeaf",
