...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.110/Connect_XCFramework_Debug.zip",
            checksum: "2b4246480b7f7ba98f41085097e166c14723763b82adebcb37f0a8cd2b8bef91"),
        .binaryTarget(
            name: "Tealeaf",
