...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.37/Connect_XCFramework_Debug.zip",
            checksum: "13956eef35b7e6083f74188403bb59b70b71ae96ba3fd2e589d624c7ef6676e4"),
        .binaryTarget(
            name: "Tealeaf",
