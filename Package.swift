...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.116/Connect_XCFramework_Debug.zip",
            checksum: "8c08b4b5eec6028f18a0e5bfd8c052d30098c98289c6ffe7b074358af74a7976"),
        .binaryTarget(
            name: "Tealeaf",
