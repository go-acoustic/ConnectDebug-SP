...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.31/Connect_XCFramework_Debug.zip",
            checksum: "ccdbda2740768452e1cc0d76b93db1eb29991528cddc438c0211e7c9997e7c65"),
        .binaryTarget(
            name: "Tealeaf",
