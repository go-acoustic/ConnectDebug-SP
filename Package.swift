...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.18/Connect_XCFramework_Debug.zip",
            checksum: "845b6d911c2c0d2dd633dc6e677d8477e06d277c1590f3daa392447dc17a883e"),
        .binaryTarget(
            name: "Tealeaf",
