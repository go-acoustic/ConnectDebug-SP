...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.59/Connect_XCFramework_Debug.zip",
            checksum: "34d7b3ff82b5c3428d33795da3a25ebcbe2ca453f0fd997ffd6b605be80c81f0"),
        .binaryTarget(
            name: "Tealeaf",
