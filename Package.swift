...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.117/Connect_XCFramework_Debug.zip",
            checksum: "378a8e5908fb5b18526247fcddc18a98e115f4c8b2f4ee0819aa65e021a8768e"),
        .binaryTarget(
            name: "Tealeaf",
