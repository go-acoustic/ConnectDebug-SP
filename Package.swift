...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.34/Connect_XCFramework_Debug.zip",
            checksum: "0e982063dff15e6190a7779cb9cb8c07c8e7c853af266e711be1a80df7b32465"),
        .binaryTarget(
            name: "Tealeaf",
