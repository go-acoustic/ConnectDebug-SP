...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.102/Connect_XCFramework_Debug.zip",
            checksum: "6655b73c53c2e479842e072e1391348d24461f4fba3915dfa9019003664e96b0"),
        .binaryTarget(
            name: "Tealeaf",
