...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.16/Connect_XCFramework_Debug.zip",
            checksum: "dc2379ccdb1c546b2c0376ebee97bdb2e8d76f012b5deedc94405eaef82cf866"),
        .binaryTarget(
            name: "Tealeaf",
